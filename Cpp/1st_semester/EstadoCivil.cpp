...
int main(){
    ...
    cout << "(1 - Casado 2 - Solteiro 3 - Vi�vo 4 - Divorciado)" << endl;
  ...
  cout << "Quantidade de pessoas vi�vas: " << viuvo << endl;
  cout << "A porcentagem de pessoas divorciadas corresponde a: " << porcentagemDivorciado << "%";
  cout << "A m�dia das idades das pessoas viuvas corresponde a: " << idadeViuvo;
